 ...
 *
 * <p>{@code RelativePath1C} instances are immutable.</p>
 */
public class RelativePath1C implements Serializable, Comparable<RelativePath1C>, CharSequence {
    public static final RelativePath1C EMPTY_ROOT = new RelativePath1C(false);
    private final boolean endsWithFile;
    private final String[] segments;

    /**
     * Creates a {@code RelativePath1C}.
     *
     * @param endsWithFile - if true, the path ends with a file, otherwise a directory
     */
    public RelativePath1C(boolean endsWithFile, String... segments) {
        this(endsWithFile, null, segments);
    }

    RelativePath1C(boolean endsWithFile, @Nullable RelativePath1C parentPath, String... childSegments) {
        ...
        if (parentPath != null) {
            ...
            for (String segment : sourceSegments) {
                segments[nextIndex] = segment;
                nextIndex++;
            }
            // System.arraycopy(sourceSegments, 0, segments, 0, sourceSegments.length);
        ...
        // System.arraycopy(childSegments, 0, segments, targetOffsetForChildSegments, childSegments.length);
    }
    ...
    public boolean equals(Object o) {
        ...
        RelativePath1C that = (RelativePath1C) o;
     ...
     */
    public RelativePath1C getParent() {
        switch (segments.length) {
            ...
            default:
                ...
                return new RelativePath1C(false, parentSegments);
        }
    }

    public static RelativePath1C parse(boolean isFile, String path) {
        return parse(isFile, null, path);
    }

    public static RelativePath1C parse(boolean isFile, @Nullable RelativePath1C parent, String path) {
        String[] names = FilePathUtil.getPathSegments(path);
        return new RelativePath1C(isFile, parent, names);
    }
     ...
     * @return The path.
     */
    public RelativePath1C replaceLastName(String name) {
        ...
        return new RelativePath1C(endsWithFile, newSegments);
    }
     ...
     * @return The new path
     */
    public RelativePath1C append(RelativePath1C other) {
        return new RelativePath1C(other.endsWithFile, this, other.segments);
    }
     ...
     * @return The new path
     */
    public RelativePath1C plus(RelativePath1C other) {
        return append(other);
    }
     ...
     * @return The new path.
     */
    public RelativePath1C append(boolean endsWithFile, String... segments) {
        return new RelativePath1C(endsWithFile, this, segments);
    }
     ...
     * @return The new path.
     */
    public RelativePath1C prepend(String... segments) {
        return new RelativePath1C(false, segments).append(this);
    }

    @Override
    public int compareTo(RelativePath1C o) {

 ...
 *
 * <p>{@code RelativePath3B} instances are immutable.</p>
 */
public class RelativePath3B implements Serializable, Comparable<RelativePath3B>, CharSequence {
    public static final RelativePath3B EMPTY_ROOT = new RelativePath3B(false);
    private final boolean endsWithFile;
    private final String[] segments;

    /**
     * Creates a {@code RelativePath3B}.
     *
     * @param endsWithFile - if true, the path ends with a file, otherwise a directory
     */
    public RelativePath3B(boolean endsWithFile, String... segments) {
        this(endsWithFile, null, segments);
    }

    RelativePath3B(boolean endsWithFile, @Nullable RelativePath3B parentPath, String... childSegments) {
    ...
    public boolean equals(Object o) {
        ...
        RelativePath3B that = (RelativePath3B) o;
     ...
     */
    public RelativePath3B getParent() {
        switch (segments.length) {
            ...
            default:
                ...
                return new RelativePath3B(false, parentSegments);
        }
    }

    public static RelativePath3B parse(boolean isFile, String path) {
        return parse(isFile, null, path);
    }

    public static RelativePath3B parse(boolean isFile, @Nullable RelativePath3B parent, String path) {
        String[] names = FilePathUtil.getPathSegments(path);
        return new RelativePath3B(isFile, parent, names);
    }
     ...
     * @return The path.
     */
    public RelativePath3B replaceLastName(String name) {
        ...
        return new RelativePath3B(endsWithFile, newSegments);
    }
     ...
     * @return The new path
     */
    public RelativePath3B append(RelativePath3B other) {
        return new RelativePath3B(other.endsWithFile, this, other.segments);
    }
     ...
     * @return The new path
     */
    public RelativePath3B plus(RelativePath3B other) {
        return append(other);
    }
     ...
     * @return The new path.
     */
    public RelativePath3B append(boolean endsWithFile, String... segments) {
        return new RelativePath3B(endsWithFile, this, segments);
    }
     ...
     * @return The new path.
     */
    public RelativePath3B prepend(String... segments) {
        return new RelativePath3B(false, segments).append(this);
    }

    @Override
    public int compareTo(RelativePath3B o) {

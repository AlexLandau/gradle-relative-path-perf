 ...
 *
 * <p>{@code RelativePath2B} instances are immutable.</p>
 */
public class RelativePath2B implements Serializable, Comparable<RelativePath2B>, CharSequence {
    public static final RelativePath2B EMPTY_ROOT = new RelativePath2B(false);
    private final boolean endsWithFile;
    private final String[] segments;

    /**
     * Creates a {@code RelativePath2B}.
     *
     * @param endsWithFile - if true, the path ends with a file, otherwise a directory
     */
    public RelativePath2B(boolean endsWithFile, String... segments) {
        this(endsWithFile, null, segments);
    }

    RelativePath2B(boolean endsWithFile, @Nullable RelativePath2B parentPath, String... childSegments) {
        ...
        int nextIndex = 0;
        if (parentPath != null) {
            for (String segment : parentPath.segments) {
                if (segment.equals(".")) {
                    continue;
                }
                if (segment.equals("..")) {
    ...
    public boolean equals(Object o) {
        ...
        RelativePath2B that = (RelativePath2B) o;
     ...
     */
    public RelativePath2B getParent() {
        switch (segments.length) {
            ...
            default:
                ...
                return new RelativePath2B(false, parentSegments);
        }
    }

    public static RelativePath2B parse(boolean isFile, String path) {
        return parse(isFile, null, path);
    }

    public static RelativePath2B parse(boolean isFile, @Nullable RelativePath2B parent, String path) {
        String[] names = FilePathUtil.getPathSegments(path);
        return new RelativePath2B(isFile, parent, names);
    }
     ...
     * @return The path.
     */
    public RelativePath2B replaceLastName(String name) {
        ...
        return new RelativePath2B(endsWithFile, newSegments);
    }
     ...
     * @return The new path
     */
    public RelativePath2B append(RelativePath2B other) {
        return new RelativePath2B(other.endsWithFile, this, other.segments);
    }
     ...
     * @return The new path
     */
    public RelativePath2B plus(RelativePath2B other) {
        return append(other);
    }
     ...
     * @return The new path.
     */
    public RelativePath2B append(boolean endsWithFile, String... segments) {
        return new RelativePath2B(endsWithFile, this, segments);
    }
     ...
     * @return The new path.
     */
    public RelativePath2B prepend(String... segments) {
        return new RelativePath2B(false, segments).append(this);
    }

    @Override
    public int compareTo(RelativePath2B o) {
